...
impl BuiltinAction {
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            BuiltinAction::CycleKindFilter => "cycle-kind-filter",
            BuiltinAction::Enqueue => "enqueue",
            BuiltinAction::Wedge => "wedge",
            BuiltinAction::Like => "like",
            BuiltinAction::LikePlaying => "like-playing",
