...
pub(super) struct Chrome {
    ...
    pub(super) copy_link_key: Option<char>,
    ...
    pub(super) like_playing_key: Option<char>,
        ...
        self.with_session(|s| {
            ...
            let chrome = self.chrome.get_or_build((s.revision(), s.warnings_revision()), || {
                ...
                Arc::new(Chrome {
                    ...
                    copy_link_key: key(BuiltinAction::CopyLink),
                    ...
                    like_playing_key: key(BuiltinAction::LikePlaying),
