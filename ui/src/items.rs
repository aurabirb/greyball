...
pub const ITEMS: &[Item] = &[
    ...
    action(BuiltinAction::OpenHelp, &["help", "h"], "open this window", "Enter on a row gives it a new key, Backspace its default back."),
    ...
    fixed(
        ...
        "On a row of a Playlists list; Backspace clears it. With a track selected, a playlist's key adds it to or removes it from that playlist.",
    ),
