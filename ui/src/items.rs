...
pub const ITEMS: &[Item] = &[
    ...
    command(
        ...
        &["open", "o"],
        "[<url-or-path>]",
        "open a playlist link, add a track link, an M3U file or local audio files",
        "Playlist link: opens as a list. Track link: added to the open playlist, or the queue. M3U: imported. Audio files: added to the open playlist. No argument: the file browser.",
    ),
